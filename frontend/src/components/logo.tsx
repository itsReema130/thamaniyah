...
const Logo = () => (
  <svg width="30" height="49.46280991735537" viewBox="0 0 363 399" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <linearGradient id="paint0_linear_0" x1="264.38" y1="53.7644" x2="45.98" y2="436.614" gradientUnits="userSpaceOnUse">
        <stop offset="0.31" stopColor="#3ADEE6" />
        <stop offset="0.44" stopColor="#38D8E0" />
        <stop offset="0.61" stopColor="#33C6CE" />
        <stop offset="0.82" stopColor="#2BA9B0" />
        <stop offset="1" stopColor="#21888F" />
      </linearGradient>
      <linearGradient id="paint1_linear_0" x1="288.51" y1="362.514" x2="46.98" y2="133.834" gradientUnits="userSpaceOnUse">
        <stop offset="0.15" stopColor="#9B7DD9" />
        <stop offset="0.37" stopColor="#7D63B3" />
        <stop offset="0.57" stopColor="#664F95" />
        <stop offset="0.75" stopColor="#584283" />
        <stop offset="0.88" stopColor="#533E7D" />
      </linearGradient>
      <radialGradient id="paint2_radial_0" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(91.39 51.4944) scale(480.67)">
        <stop offset="0.35" stopColor="#FF78C9" />
        <stop offset="0.42" stopColor="#FD7ECB" />
        <stop offset="0.51" stopColor="#F890D1" />
        <stop offset="0.62" stopColor="#EFAEDB" />
        <stop offset="0.66" stopColor="#EBBCE0" />
      </radialGradient>
    </defs>
  </svg>
);
